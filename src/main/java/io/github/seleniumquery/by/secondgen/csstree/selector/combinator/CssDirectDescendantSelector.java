...
public class CssDirectDescendantSelector extends CssCombinationSelector {

    public CssDirectDescendantSelector(CssSelector leftSideSelector, CssSelector rightSideSelector) {
