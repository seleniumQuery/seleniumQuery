...
public abstract class AstCssImagePseudoClass extends CssInputTypeAttributePseudoClass implements AstCssPseudoClassCondition {
    public static final String PSEUDO = "image";

    public AstCssImagePseudoClass(String typeAttributeValue) {
