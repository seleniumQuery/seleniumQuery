...
package io.github.seleniumquery.by.secondgen.parser.ast.condition.pseudoclass.contentfilter;
...
public class AstCssContainsPseudoClass extends AstCssFunctionalPseudoClassCondition<String> {

    public static final String PSEUDO = "contains";

    public AstCssContainsPseudoClass(String argument) {
        super(argument);
    }
