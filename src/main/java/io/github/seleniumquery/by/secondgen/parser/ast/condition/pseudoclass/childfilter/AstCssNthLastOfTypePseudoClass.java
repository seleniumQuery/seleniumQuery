...
package io.github.seleniumquery.by.secondgen.parser.ast.condition.pseudoclass.childfilter;
...
public class AstCssNthLastOfTypePseudoClass extends AstCssFunctionalPseudoClassCondition<String> {

    public static final String PSEUDO = "nth-last-of-type";

    public AstCssNthLastOfTypePseudoClass(String argument) {
        super(argument);
    }
