...
package io.github.seleniumquery.internal.functions.assertthat;

import io.github.seleniumquery.SeleniumQueryException;
import io.github.seleniumquery.SeleniumQueryObject;
import io.github.seleniumquery.wait.FluentFunction;
...
public class FluentAssertThat implements FluentFunction {
    ...
    public <T> SeleniumQueryObject apply(Evaluator<T> evaluator, T value, SeleniumQueryObject sqo,
        ...
        if (fluentBehaviorModifier.isNotExpectedBehavior(passedAssertion)) {
            throw new SeleniumQueryException("Failed assertion: "+sqo+".assertThat()."+evaluator.stringFor(value, fluentBehaviorModifier));
        }
        return sqo;
    }
