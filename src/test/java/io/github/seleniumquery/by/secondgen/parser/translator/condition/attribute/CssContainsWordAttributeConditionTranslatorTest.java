...
public class CssContainsWordAttributeConditionTranslatorTest {

    @Test
    public void translate() {
        AttributeConditionTestUtils.verifySelectorYieldsAttrCondition(CssContainsWordAttributeCondition.class, "[values~=\"10\"]", "values", is("10"));
    }
