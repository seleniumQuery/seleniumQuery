...
public class CssRadioPseudoClassTest {

    private static final String RADIO_PSEUDO = ":radio";
    private static final String RADIO_CSS_SELECTOR = "input[type=\"radio\"]";
    private static final String RADIO_XPATH_EXPRESSION = ".//*[(self::input and " + TYPE_ATTR_LOWER_CASE + " = 'radio')]";
