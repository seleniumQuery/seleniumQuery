...
public class CssStartsWithAttributeConditionTranslatorTest {

    @Test
    public void translate() {
        AttributeConditionTestUtils.verifySelectorYieldsAttrCondition(CssStartsWithAttributeCondition.class, "[abc^=\"def\"]", "abc", is("def"));
    }
