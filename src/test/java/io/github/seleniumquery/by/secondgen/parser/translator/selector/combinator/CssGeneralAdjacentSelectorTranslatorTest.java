...
public class CssGeneralAdjacentSelectorTranslatorTest {

    @Test
    public void translate() {
        // given
        CssSelector cssSelector = ParseTreeBuilder.parse("a ~ b").firstSelector();
        assertThat(cssSelector, instanceOf(CssGeneralAdjacentSelector.class));
        // when
        CssSelector ancestorSelector = ((CssGeneralAdjacentSelector) cssSelector).getLeftSideSelector();
        CssSelector descendantSelector = ((CssGeneralAdjacentSelector) cssSelector).getRightSideSelector();
        // then
