...
public class CssEndsWithAttributeConditionTranslatorTest {

    @Test
    public void translate() {
        AttributeConditionTestUtils.verifySelectorYieldsAttrCondition(CssEndsWithAttributeCondition.class, "[attr$=\"end\"]", "attr", is("end"));
    }
