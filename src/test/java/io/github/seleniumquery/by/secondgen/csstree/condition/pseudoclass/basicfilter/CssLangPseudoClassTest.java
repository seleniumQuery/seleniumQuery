...
public class CssLangPseudoClassTest {

    @Test
    public void translate() {
        assertQueriesOnSelector(":lang").withAllKindsOfArguments().yieldFunctionalPseudoclassWithCorrectlyTranslatedArguments(CssLangPseudoClass.class);
    }
